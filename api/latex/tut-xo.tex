...
\begin{DoxyImage}
\includegraphics{opt-set-castep.png}
\caption{width=}
\end{DoxyImage}
...
\textcolor{preprocessor}{}\textcolor{preprocessor}{#PBS -l nodes=1:ppn=8}
\textcolor{preprocessor}{}\textcolor{preprocessor}{#PBS -o ../%gen%x%id%-%optstep%.out}
\textcolor{preprocessor}{}\textcolor{preprocessor}{#PBS -e ../%gen%x%id%-%optstep%.err}
\textcolor{preprocessor}{}\textcolor{preprocessor}{#PBS -N %description%-%gen%x%id%-%optstep%}
\textcolor{preprocessor}{}
\textcolor{preprocessor}{###Include this for XtalOpt scripts!###}
\textcolor{preprocessor}{}export PBS\_O\_WORKDIR=%rempath%

\textcolor{preprocessor}{# Change to structure's working directory, copy input files to node's scratch dirs:}
\textcolor{preprocessor}{}\textcolor{keywordflow}{for} node in `cat $PBS\_NODEFILE | sort | uniq`; \textcolor{keywordflow}{do}
rsh $node \textcolor{stringliteral}{"cp $PBS\_O\_WORKDIR/* $PBSTMPDIR/;"};
done

\textcolor{preprocessor}{# Move to the scratch directory}
\textcolor{preprocessor}{}cd $PBSTMPDIR
...
\textcolor{preprocessor}{}\textcolor{preprocessor}{# See the template menu in XtalOpt and the example templates in the}
\textcolor{preprocessor}{}\textcolor{preprocessor}{# samples/ directory of the XtalOpt sources.}
\textcolor{preprocessor}{}
